...
Page({
    ...
    onGoOrder(e){
        ...
        wx.navigateTo({
            url: '/pages/share/confirmOrder/termCard/index?card=' + JSON.stringify(card) + '&sortId=' + sortId + '&money=' + money + '&venueGoodsId=' + venueGoodsId + '&packageId=' + packageId + '&customerId=' + customerId + '&type=' + type,
        })
    },
    onMap(e) {
        let {
